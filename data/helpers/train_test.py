...
file_train = open('custom_data/train.txt', 'w')
file_test = open('custom_data/test.txt', 'w')
...
for file in glob.iglob(os.path.join(current_dir, '*.jpg')):
	...
	if counter == index_test:
		counter = 1
		file_test.write(current_dir + "/custom_data/" + title + '.jpg' + "\n")
	else:
		file_train.write(current_dir + "/custom_data/" + title + '.jpg' + "\n")
	counter = counter + 1
